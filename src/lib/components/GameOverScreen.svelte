...
<div class="overlay" class:visible={game.screen === 'gameOver'}>
  {#if game.gameOverData}
    <div class="card">
      ...
      <div class="stats">
        <div class="stat">
          <div class="stat-value">{game.gameOverData.wordsDone}</div>
          <div class="stat-label">Words</div>
        </div>
        <div class="stat">
          <div class="stat-value">{game.gameOverData.totalScore.toLocaleString()}</div>
          <div class="stat-label">Score</div>
        </div>
        <div class="stat">
          <div class="stat-value">Lvl {game.gameOverData.levelReached}</div>
