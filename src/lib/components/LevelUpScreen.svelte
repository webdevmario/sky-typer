...
<div class="overlay" class:visible={game.screen === 'levelUp'}>
  {#if game.levelUpData}
    <div class="card">
      ...
      <div class="stats">
        <div class="stat"><div class="stat-value">{game.levelUpData.wordsDone}</div><div class="stat-label">Words</div></div>
        <div class="stat"><div class="stat-value">{game.score.toLocaleString()}</div><div class="stat-label">Score</div></div>
        <div class="stat"><div class="stat-value">{game.levelUpData.timeRemaining}s</div><div class="stat-label">Time Left</div></div>
        <div class="stat"><div class="stat-value">⚡{game.levelUpData.speedBonus}</div><div class="stat-label">Speed Bonus</div></div>
      </div>
